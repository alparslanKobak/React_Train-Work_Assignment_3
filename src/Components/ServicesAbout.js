                        ...
                        <div className="col-lg-6 col-xl-5 text-center text-md-left section-special-2 left small-section">
                            <div className="z-index-2">
                                <div>
                                    ...
                                    <div className="fw-divider-space divider-40 divider-lg-0" />
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-xl-7">
                            <div
                                className="owl-carousel owl-three-opacity"
                            ...
                            >
                                <div className="vertical-item bg-darkblue text-center service-layout-1 box-shadow  content-padding">
                                    <div className="item-media">
                                        <img src="assets/images/services/img_1.jpg" alt="img" />
                                    ...
                                    <div className="item-content">
                                        ...
                                        <a href="service-single.html" className="mt-30 font-2">
                                ...
                                <div className="vertical-item bg-darkblue text-center service-layout-1 box-shadow  content-padding">
                                    <div className="item-media">
                                        <img src="assets/images/services/img_2.jpg" alt="img" />
                                        <div className="media-links">
                                            <a className="abs-link" title="" href="service-single.html" />
                                        </div>
                                    </div>
                                ...
                                <div className="vertical-item bg-darkblue text-center service-layout-1 box-shadow  content-padding">
                                    <div className="item-media">
                                        <img src="assets/images/services/img_3.jpg" alt="img" />
                                        <div className="media-links">
                                            <a className="abs-link" title="" href="service-single.html" />
                                        </div>
                                    </div>
                                ...
                                <div className="vertical-item bg-darkblue text-center service-layout-1 box-shadow  content-padding">
                                    <div className="item-media">
                                        <img src="assets/images/services/img_4.jpg" alt="img" />
                                        <div className="media-links">
                                            <a className="abs-link" title="" href="service-single.html" />
                                        </div>
                                    </div>
                                ...
                                <div className="vertical-item bg-darkblue text-center service-layout-1 box-shadow  content-padding">
                                    <div className="item-media">
                                        <img src="assets/images/services/img_5.jpg" alt="img" />
                                        <div className="media-links">
                                            <a className="abs-link" title="" href="service-single.html" />
                                        </div>
                                    </div>
                                ...
                                <div className="vertical-item bg-darkblue text-center service-layout-1 box-shadow  content-padding">
                                    <div className="item-media">
                                        <img src="assets/images/services/img_6.jpg" alt="img" />
                                        <div className="media-links">
                                            <a className="abs-link" title="" href="service-single.html" />
                                        </div>
                                    </div>
